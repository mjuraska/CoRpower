...
ans <- computePower(nAtRiskTauCases = 32,                # n_cases
                    ...
                    VElat0 = seq(0, VEoverall, len=100), # grid of VE (V/P) among lower protected
                    VElat1 = rep(VEoverall, 100),        # grid of VE (V/P) among medium protected
                    Plat0 = 0.2,                         # scalar, ie separate calls for 0.05, 0.1, 0.15, 0.2
                    Plat2 = 0.6,                         # scalar, ie separate calls for 0.15, 0.3, 0.45, 0.6
                    P0 = 0.2,                            # scalar, ie separate calls for 0.05, 0.1, 0.15, 0.2
                    P2 = 0.6,                            # scalar, ie separate calls for 0.15, 0.3, 0.45, 0.6
                    M = 1000,                            # number of simulated clinical trials
                    alpha = 0.05,                        # two-sided Wald test Type 1 error rate
