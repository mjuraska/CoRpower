...
pwr <- computePower(nCases = c(25, 32, 35, 40),             
                    nControls = c(3998, 3654, 3988, 3983),  
...
Other components: `betaLat`, `alphaLat`, `PlatVElowest`, `N`, `nCases`, `nCasesPhase2`, `controlCaseRatio`, `VEoverall`, `alpha`, `rho`,
...
### Plotting of power curves
```{r, eval=FALSE}
plotPowerContinuous(outComputePower = pwr,          # output list from 'computePower'
                    legendText = paste0("rho = ", c(1, 0.9, 0.7, 0.5)))
```
