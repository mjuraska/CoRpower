...
```{r, eval=FALSE}
library(CoRpower)
pwr <- computepower(numAtRiskTauCases = 31,           # n_cases
                    numAtRiskTauCasesPhase2 = 31,     # num^S_cases
                    ...
                    PlatVElowest = 0,                 # prevalence of VE_lowest
                    VElowestvect = NULL,              # lowest VE level for true biomarker X* <= \nu
...
## Scenario 1 Output for `controlCaseRatio=5` | List of 23 elements: {.smaller}
<ul>
<li>`powerstrinary`
```{r, echo=FALSE}
powerstrinary[1,1:7]
