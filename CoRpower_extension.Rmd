...
#### Trichotomous \(\, S(1)\) using Approach 2 or continuous \(\, S^*(1)\)
<ul>
...
$$
<li> Next, we have a trichotomous $S(1)$ with a distribution defined by $P_x$, $x=0,1,2$, where
$$
P_x  = \sum_{k=0}^2 P\{S(1)=x \mid X=k\} P^{lat}_k,
$$
with the conditional probabilities $P\{S(1)=x \mid X=k\}$, $x, k=0,1,2$, specified by the user
