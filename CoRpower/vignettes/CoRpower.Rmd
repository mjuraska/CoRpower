...
load("T:/vaccine/StephanieWu/CoR Power Package In Progress/Scenario1/K3/ansScen1.RData")
pwr5to1 <- pwr
devtools::use_data(pwr5to1, internal = TRUE, overwrite=TRUE)
```

### Output list for `controlCaseRatio = 5`:
```{r}
names(pwr5to1)
pwr5to1$power[1, c(1, 25, 50, 75, 100)]
pwr5to1$RRt[1, c(1, 25, 50, 75, 100)]
pwr5to1$VElat2[c(1, 25, 50, 75, 100)]
```
...
load("T:/vaccine/StephanieWu/CoR Power Package In Progress/Scenario9/ansScen9.RData")
pwr <- pwr
devtools::use_data(pwr, internal = TRUE, overwrite=TRUE)
```
